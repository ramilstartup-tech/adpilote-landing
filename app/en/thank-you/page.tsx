...
export const metadata: Metadata = {
  title: "Thank You | AdPilote - AI-Powered Google Ads Copilot",
  description: "You're on the waitlist for AdPilote beta access.",
};
      ...
      <div className="max-w-2xl w-full">
        <div className="rounded-2xl border border-slate-200 bg-white p-8 md:p-12 shadow-lg text-center space-y-6">
          ...
          <div className="space-y-4 text-slate-600">
            <p className="text-lg">
              Thank you for your interest in AdPilote. We'll notify you as soon
              as beta access becomes available.
            </p>
            <p>
              In the meantime, feel free to connect with us on LinkedIn to stay
